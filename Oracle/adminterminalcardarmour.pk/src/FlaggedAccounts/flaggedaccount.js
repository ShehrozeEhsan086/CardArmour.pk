...
import {
  deleteFlaggedAccount,
  getAllFlaggedCustomers,
  getAllCities,
  countriesAPI,
  deleteUser,
...
const Cardhistory = () => {
  ...
  const [flaggedid_, setFlaggedid] = useState("");
  ...
  const removeFlag = (e) => {
    //e.preventDefault();
    let flaggedid = flaggedid_;
    console.log(flaggedid);
    deleteFlaggedAccount(flaggedid).then((response) => {});
              ...
              <tr>
                ...
                <td>
                  ...
                  <Button
                    ...
                    style={{ color: "yellow" }}
                    onClick={() => {
                      deleteFlaggedAccount(flaggedUser.flaggedid).then(
                        (response) => {
                          window.location.reload(true);
                        }
                      );

                      //console.log(flaggedUser.flaggedid);
                    }}
                  />
                  <Button
                    onClick={() => {
                      ...
                      let userid;
                      getUseridByCustomerid(flaggedUser.customerid).then(
                        (response) => {
